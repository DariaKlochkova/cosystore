...
<#macro menu>
    <nav id="upper-nav" class="navbar navbar-expand-lg">
        <#if user??>
            <a id="userName" class="mr-auto" <#if user.hasUserRole()>href="/lk"</#if> style="color: #111">
                <i class="far fa-user"></i> ${user.surname} ${user.firstname}
            </a>
    ...
    <nav class="navbar navbar-expand-lg" id="main-navbar">
        <div class="container">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown" style="margin-right: 20px;">
                    <div class="nav-link" id="room-menu-btn" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div id="room-menu" style="display: none">
                            <#list rooms as room>
                                <a href="/products/rooms/${room.name()}">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/promotions">Цена ниже</a>
                </li>
            </ul>
            <form class="form-inline my-2 my-lg-0" id="search" action="/search">
                <input name="query" class="form-control mr-sm-2" id="search-input" type="text" placeholder="Что вы ищете?" aria-label="Search" autocomplete="off" />
    ...
    <footer class="page-footer font-small">
        <div class="footer-copyright text-center py-3">
            © 2019 Copyright: <span style="color: white">CosyStore.ru</span>
        </div>
    </footer>
