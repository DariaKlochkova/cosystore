...
<@c.page "../" "Клочкова Дарья">
   <@c.admin "Добавление товара">
         ...
         <form action="/admin/add" method="get" id="form-category">
            <div class="row mb-4">
               <div class="col-3">
                  <label for="inputCategory">Категория</label>
                  <input type="text" name="categoryName" value="${categoryName}" id="inputCategory" class="form-control" onclick="showDropdown()" readonly>
         ...
         <form action="/admin/add" method="post" enctype="multipart/form-data">
            ...
            <div class="row mb-4">
               ...
               <div class="col-2">
                  ...
                  <input type="number" name="count" id="inputCount" class="form-control">
               </div>
            </div>
            <div class="row mb-4">
               <div class="col-5">
            ...
            <div class="row mb-5">
               ...
               <div class="col-sm-3 pl-0">
                  <input type="number" name="height" class="form-control" id="inputHeight" placeholder="см">
               </div>
               <label for="inputWidth" class="col-sm-1 col-form-label">Ширина</label>
               <div class="col-sm-3 pl-0">
                  <input type="number" name="width" class="form-control" id="inputWidth" placeholder="см">
               </div>
               <label for="inputDepth" class="col-sm-1 col-form-label">Глубина</label>
               <div class="col-sm-3 pl-0">
                  <input type="number" name="depth" class="form-control" id="inputDepth" placeholder="см">
               </div>
            </div>
            <div class="row">
               <div class="col-12">
            ...
            <button type="submit" class="btn btn-lg" id="btn-add">Добавить</button>
