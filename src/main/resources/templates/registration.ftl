...
<div class="container">
    <form class="form-signin" method="post" action="/registration">
        ...
        <p>
            ...
            <input type="text" id="firstname" name="firstname" class="form-control login-input" placeholder="Имя" autocomplete="false" required autofocus>
        </p>
        <p class="mb-5">
            <label for="surname" class="sr-only">Фамилия</label>
            <input type="text" id="surname" name="surname" class="form-control login-input" placeholder="Фамилия" autocomplete="false" required>
        </p>
        <p>
            <label for="username" class="sr-only">Логин</label>
            <input type="text" id="username" name="username" class="form-control login-input" placeholder="Логин" autocomplete="false" required>
        </p>
        <p>
